...
export default {
  ...
  modals: {
    ...
    privacy: {
      company: {
        name: { en: site.title, it: site.title },
        url: { en: sharedStrings.company.url, it: sharedStrings.company.url },
        email: { en: site.email, it: site.email },
        address: { en: site.address, it: site.address }
      }
    }
  }
}
